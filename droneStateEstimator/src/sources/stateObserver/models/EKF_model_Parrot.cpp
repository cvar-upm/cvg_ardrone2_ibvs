...
//Parrot Modelo 1
void ParrotModel1::processModel(Vector* Statek1, Vector* Statek, Vector* Inputs)
{
  // ************** State ************** 
  // Xestate order
...
void ParrotModel1::observationModel(Vector* Output, Vector* Statek)
{
	//  Medidas:
	//  01 pitch: C(1,1)*X1
	//  02 roll : C(2,2)*X2
...
void ParrotModel1::jacobiansProcessModel(Matrix* MatJacFx, Matrix* MatJacFu, Vector* Statek, Vector* Inputs)
{
...
void ParrotModel1::jacobiansObservationModel(Matrix* MatJacHx, Vector* Statek)
{
	//  Medidas:
	//  01 pitch: C(1,1)*X1
	//  02 roll : C(2,2)*X2
