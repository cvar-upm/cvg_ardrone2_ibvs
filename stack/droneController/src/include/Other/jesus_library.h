...
//	std::string convertInt(int number);
	...
	cvg_int fmod(cvg_int numerator, cvg_int denominator);
//	void unitaryVectorFrom2Points( Vector &ur, Vector &p0, Vector &p1);
	cvg_double unitaryVectorFrom2Points( Vector &ur, Vector &p0, Vector &p1); // from p0 to p1
	...
	double calculateVmax( Vector &r_ur, cvg_double vmax_xy, cvg_double vmax_z);
	void mostrarVector( cvgString nombreVector, Vector &u);
};
